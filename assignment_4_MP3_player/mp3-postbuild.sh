...
sed -i "26s/.*/checkForDevices &" 	${TARGET_DIR}/etc/init.d/rcS
sed -i "27s/.*/findMP3Players &" 	${TARGET_DIR}/etc/init.d/rcS
sed -i "27s/.*/buttonsScript &" 	${TARGET_DIR}/etc/init.d/rcS
sed -i "28s/.*/done"		  	${TARGET_DIR}/etc/init.d/rcS
